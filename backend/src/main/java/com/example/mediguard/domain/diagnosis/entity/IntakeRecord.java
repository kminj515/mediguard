...
import com.example.mediguard.domain.member.entity.Member; // Member는 다른 폴더에 있으니 import 필요
...
public class IntakeRecord extends BaseEntity { // 기존 BaseEntity 상속 규칙 적용[cite: 5, 7]
    ...
    @Column(name = "is_empty_stomach")
    private boolean isEmptyStomach; // 공복 상태에서 복용했는지

    @Column(name = "alert_needed", nullable = false)
