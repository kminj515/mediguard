package com.example.mediguard.domain.video.service;


import com.example.mediguard.domain.video.exception.VideoException;
import com.example.mediguard.domain.video.converter.PreventionVideoConverter;
import com.example.mediguard.domain.video.converter.VideoCategoryConverter;
import com.example.mediguard.domain.video.dto.req.CategoryWithVideosDto;
import com.example.mediguard.domain.video.dto.req.PreventionVideoDto;
import com.example.mediguard.domain.video.dto.req.VideoCategoryDto;
import com.example.mediguard.domain.video.entity.PreventionVideo;
import com.example.mediguard.domain.video.entity.VideoCategory;
import com.example.mediguard.domain.video.enums.VideoErrorCode;
import com.example.mediguard.domain.video.repository.PreventionVideoRepository;
import com.example.mediguard.domain.video.repository.VideoCategoryRepository;
